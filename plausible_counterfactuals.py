...
class PlausibleCounterfactualOfHyperplaneClassifier():
    def __init__(self, w, b, n_dims, ellipsoids_r, gmm_weights, gmm_means, gmm_covariances, projection_matrix=None, projection_mean_sub=None, density_constraint=True, density_threshold=-85):
        self.w = w
        self.b = b
...
class PlausibleCounterfactualOfDecisionTree():
    def __init__(self, model, n_dims, ellipsoids_r, gmm_weights, gmm_means, gmm_covariances, projection_matrix=None, projection_mean_sub=None, density_constraint=True, density_threshold=-85):
        self.model = model
